...
num_decoder_sparse_layer = 32 # switch-32/64/128/256: 6; mixtral: 32
num_experts_per_layer = 8 # mixtral: 8
...
class DataArguments:
    ...
    # data_name = 'wmt16'
    data_path: str = field(
        default=f"marsggbo/{data_name}_mixtral8x7bInstructv0.1_token_patterns", metadata={"help": "Path to the training data."}
    )
...
class CustomArguments:
    ...
    dim_ff: float = field(default=2048, metadata={"help": "dimension ffn"})
    dim_model: float = field(default=32, metadata={"help": "dimension of model"})
